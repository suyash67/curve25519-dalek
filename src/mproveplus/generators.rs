...
use std::vec::Vec;
use constants::{ED25519_BASEPOINT_COMPRESSED, ED25519_BASEPOINT_POINT};
...
///
/// * `B`: the `ed25519` basepoint;
/// * `B_blinding`: the result of `ed25519` SHA3-512
...
impl Default for PedersenGens {
    fn default() -> Self {
        PedersenGens {
            ...
            B_blinding: EdwardsPoint::hash_from_bytes::<Sha3_512>(
...
impl Iterator for GeneratorsChain {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        Some(EdwardsPoint::from_uniform_bytes(&uniform_bytes))
    }
